...
const HistoryListPage: React.FC = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            if (fetchedData.length > 0 && !filters.q && pagination.current === 1) {
            ...
            console.error('Cannot fetch history articles');
        } finally {
            setLoading(false);
        }
    };
            ...
            <section className="hero-section">
                <div className="hero-content">
                    ...
                    <p className="hero-subtitle">
                        Hào hùng ngàn năm văn hiến - Kết nối quá khứ và hiện tại.
                    </p>
                </div>
            </section>
                ...
                <>
                    ...
                    {randomFeatured && (
                         <section className="discovered-section">
                            <Title level={2} className="header-title">Tiêu điểm</Title>
                    ...
                    <section className="undiscovered-section">
                        ...
                        <div className="section-content">
                             <Title level={2} className="header-title">Khám phá lịch sử</Title>
