...
export const useResearcherHeritageModel = () => {
    ...
    const exportData = (params?: any) => 
        heritageService.export(params);
        
    const importData = (file: File) => 
        heritageService.import(file);
        
    const downloadTemplate = () => 
        heritageService.downloadTemplate();

    const revertToDraft = async (id: any) => {
        const result = await heritageService.revertReview(id);
        if (result.success) {
