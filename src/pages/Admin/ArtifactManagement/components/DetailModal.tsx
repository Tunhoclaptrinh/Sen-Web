...
const DetailModal: React.FC<DetailModalProps> = ({open, onCancel, record}) => {
  ...
  const galleryRaw = [...(record.gallery || []), ...(record.images || [])];
        ...
        <Tabs.TabPane tab="Thông tin chung" key="info">
          <Descriptions bordered column={2}>
            ...
            <Descriptions.Item label="Hình ảnh">
              {mainSrc ? (
                <Image width={100} src={mainSrc} style={{borderRadius: 4, objectFit: "cover"}} />
              ) : (
            ...
            <Descriptions.Item label="Loại hình">
              <Tag color="purple">
                {ArtifactTypeLabels[record.artifactType as keyof typeof ArtifactTypeLabels]?.toUpperCase() ||
                  record.artifactType?.toUpperCase()}
              </Tag>
            </Descriptions.Item>
