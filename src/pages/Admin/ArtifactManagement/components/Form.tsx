...
import { ArtifactType, ArtifactCondition } from "@/types";
...
const ArtifactForm: React.FC<ArtifactFormProps> = ({
    ...
    return (
        <FormModal
            ...
            form={form}
            loading={loading}
            initialValues={{ is_on_display: true, condition: ArtifactCondition.GOOD, ...initialValues }}
        >
            <Row gutter={16}>
                <Col span={12}>
                    <Form.Item
            ...
            >
                <Input.TextArea rows={4} placeholder="Mô tả chi tiết về hiện vật..." />
            </Form.Item>
                    ...
                    <Form.Item name="condition" label="Tình trạng">
                        <Select placeholder="Chọn tình trạng">
                            {Object.values(ArtifactCondition).map((cond) => (
                                <Select.Option key={cond} value={cond}>{cond.toUpperCase()}</Select.Option>
                            ))}
                        </Select>
                    </Form.Item>
                </Col>
            ...
            <Row>
                <Col span={6}>
                    <Form.Item name="is_on_display" label="Đang trưng bày" valuePropName="checked">
                        <Switch />
                    </Form.Item>
                </Col>
            </Row>
