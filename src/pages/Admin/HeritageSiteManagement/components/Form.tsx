...
const HeritageForm: React.FC<HeritageFormProps> = ({
  ...
  initialValues,
  loading = false,
  title = "Thông tin Di sản", // TinyEditor enabled
}) => {
  ...
  return (
    ...
    >
      ...
      >
        <TinyEditor
          height={400}
          placeholder="Nhập mô tả chi tiết về di sản, lịch sử, kiến trúc, giá trị văn hóa..."
          enableImageUpload={true}
          enableVideoEmbed={true}
        />
      </Form.Item>

      <Form.Item name="historical_background" label="Nền tảng lịch sử">
        <TinyEditor
          height={300}
          placeholder="Mô tả nền tảng lịch sử hình thành và phát triển..."
        />
      </Form.Item>

      <Form.Item name="cultural_value" label="Giá trị văn hóa">
        <TinyEditor
          height={300}
          placeholder="Giá trị văn hóa, tinh thần, ý nghĩa đối với cộng đồng..."
        />
      </Form.Item>
