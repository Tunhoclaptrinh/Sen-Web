  ...
  return (
    ...
    >
      <Row gutter={[16, 12]}>
        ...
        <Col span={6}>
          <Form.Item {...restField} name={[name, "emotion"]} label="Cảm xúc">
        ...
        <Col span={12}>
          <Form.Item label="Âm thanh (Voiceover)" style={{marginBottom: 0}}>
            <div style={{display: "flex", gap: 8, alignItems: "center"}}>
              ...
              />
              <Form.Item {...restField} name={[name, "audioUrl"]} noStyle>
                {audioMode === "upload" ? (
                  <FileUpload accept="audio/*" placeholder="Tải lên..." />
                ) : (
                  <Input
                    size="small"
              ...
              {form.getFieldValue(["content", name, "audioUrl"]) && (
                <Button
                  size="small"
                  icon={<PlayCircleOutlined />}
                  onClick={() => {
                    const audioPath = form.getFieldValue(["content", name, "audioUrl"]);
