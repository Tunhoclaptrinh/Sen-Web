        ...
        try {
            ...
            if (response.success) {
                if (response.data.passed) {
                    ...
                    const isLevelUp = (response.data as any).isLevelUp;
                    const newLevel = (response.data as any).newLevel;
                                    ...
                                    >
                                        ...
                                        {module.contentType === 'video' ? (
                                            <div style={{ 
                                                ...
                                                {module.contentUrl?.trim().startsWith('<') ? (
                                                    <div 
                                                ...
                                                <div style={{ 
                                                    ...
                                                    <div style={{ position: 'relative', zIndex: 1 }}>
                                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                                                            <Title level={2} style={{ color: 'white', margin: 0, fontSize: 24, fontFamily: 'serif', display: 'flex', alignItems: 'center', gap: 12 }}>
                                                        ...
                                                        <p style={{ color: 'rgba(255,255,255,0.9)', marginTop: 0, fontSize: 16 }}>
                                                            Hãy trả lời các câu hỏi sau để nhận điểm thưởng.
                                                        </p>
                                                    </div>
                                                    {/* Decorative Circles */}
                                                    ...
                                                    {module.quiz.questions.map((q, idx) => (
                                                        ...
                                                        >
                                                            <div style={{ marginBottom: 12 }}>
                                                                ...
                                                                <Title level={4} style={{ marginTop: 4, marginBottom: 0, color: '#262626', fontSize: 16, lineHeight: 1.4 }}>
                                                                    {q.question}
                                                                </Title>
                                                            </div>
                                                                ...
                                                                <Row gutter={[12, 12]}>
                                                                    {q.options.map((opt, optIdx) => (
                                                                        <Col xs={24} key={optIdx}>
                                                                            <Radio value={optIdx} className="custom-radio" style={{ 
                                                                                width: '100%', 
                                                                                padding: '12px 16px', 
                                        ...
                                        <div style={{ 
                                           ...
                                           <div style={{ position: 'sticky', top: 140, width: 80 }}>
                                            ...
                                            >
                                                ...
                                                {/* Progress Circle */}
                                                <Tooltip title={`Đã làm: ${Object.keys(answers).length}/${module.quiz.questions.length} câu`}>
                                                    <div style={{ cursor: 'help' }}>
                                                        <Progress 
                                                            type="circle" 
                                                            percent={Math.round((Object.keys(answers).length / module.quiz.questions.length) * 100)} 
                                                            width={52} 
