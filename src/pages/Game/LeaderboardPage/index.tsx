...
import { TrophyOutlined, CrownOutlined, StarOutlined, UserOutlined } from '@ant-design/icons';
        ...
        >
            ...
            <div className="podium-card">
                <Avatar 
                    ...
                    size={rank === 1 ? 100 : 80}
                    icon={<UserOutlined />}
                    style={{ border: `4px solid ${rank === 1 ? '#ffd700' : rank === 2 ? '#c0c0c0' : '#cd7f32'}` }}
                />
                ...
                <div className="stats-grid">
                    <div className="stat-item">
                        ...
                        <span className="stat-value">{entry.total_points.toLocaleString()}</span>
                    </div>
                    <div className="stat-item">
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (points: number) => (
                <Tag color="blue" icon={<StarOutlined />} style={{ borderRadius: 12, padding: '2px 12px' }}>
        ...
        },
        {
            ...
            render: (petals: number) => (
                <Text strong style={{ color: '#ff85c0' }}>🌸 {petals}</Text>
            ),
        },
        {
            title: 'Nhân vật',
            ...
            align: 'center' as const,
            render: (count: number) => (
                <Tag color="purple" style={{ borderRadius: 12 }}>{count} nhân vật</Tag>
            ),
        },
    ];
    ...
    return (
        ...
        >
            <div className="leaderboard-header">
                ...
                <Text type="secondary">
                    Vinh danh những nhà thám hiểm xuất sắc nhất
                </Text>
            </div>
                ...
                <>
                    ...
                    <Card className="leaderboard-card">
                        <Tabs activeKey={activeTab} onChange={handleTabChange} centered>
                            <Tabs.TabPane tab="Toàn thời gian" key="global" />
                            <Tabs.TabPane tab="Tuần này" key="weekly" />
                            <Tabs.TabPane tab="Tháng này" key="monthly" />
                        </Tabs>
