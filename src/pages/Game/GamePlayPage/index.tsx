            ...
            default:
                return (
                    <div style={{ textAlign: 'center', padding: 50, color: 'white' }}>
                        <Title level={3} style={{ color: 'white' }}>Sắp ra mắt</Title>
        ...
        return (
            <div className="game-completion">
                <Card className="completion-card">
                    <Result
                        icon={<TrophyTwoTone twoToneColor="#faad14" style={{ fontSize: 72 }} />}
                        status="success"
                        ...
                        <div className="rewards-summary">
                            ...
                            <div className="rewards-grid">
                                <div className="reward-item">
                                    ...
                                    <span className="reward-value">+{completionData.rewards.coins} Xu</span>
                                </div>
                                <div className="reward-item">
                                    <span className="reward-icon">🌸</span>
