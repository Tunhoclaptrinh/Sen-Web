...
import { Spin, message, Row, Col, Typography, Empty, Tabs, Divider, Button, Image, Tag } from "antd";
import {
  CalendarOutlined,
  UserOutlined,
  HeartOutlined,
   ...
   const fetchRelated = async (currentItem: Artifact) => {
        try {
            ...
            if (currentItem.heritage_site_id) {
                const res = await artifactService.getAll({ heritage_site_id: currentItem.heritage_site_id, limit: 4 });
                if (res.data) {
  ...
  return (
    <div className="artifact-detail-page">
        ...
        <div className="artifact-hero-overlay">
            <div className="artifact-hero-container">
                ...
                <div className="artifact-hero-meta">
                    ...
                    <span><UserOutlined /> {artifact.creator || 'Không rõ'}</span>
                </div>
            </div>
      ...
      <section className="main-content">
          <div className="content-wrapper" style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px' }}>
              <Tabs
                          ...
                          children: (
                              <div className="article-main-wrapper">
                                  ...
                                  {galleryImages.length > 0 && (
                                      <>
                                        <h3 className="section-title" style={{ marginTop: 32 }}>Hình Ảnh Chi Tiết</h3>
                                      ...
                                      <Row gutter={[48, 24]}>
                                          <Col xs={24} md={12}>
                                              <ul className="info-list">
                                                  <li>
                                                      <div className="icon-wrapper"><InfoCircleOutlined /></div>
                                                  ...
                                                  <li>
                                                      <div className="icon-wrapper"><SkinOutlined /></div>
                                                      <div className="info-text">
                                                  ...
                                                  <li>
                                                      <div className="icon-wrapper"><HistoryOutlined /></div>
                                                      <div className="info-text">
                                                          <span className="label">Thời kỳ / Năm</span>
                                                          <span className="value">{artifact.year_created}</span>
                                                      </div>
                                                  </li>
                                                  <li>
                                                      <div className="icon-wrapper"><StarFilled /></div>
                                                      <div className="info-text">
                                                          <span className="label">Tình trạng</span>
                                                          <span className="value highlight-status">{artifact.condition}</span>
                                                      </div>
                                                  </li>
                                              </ul>
                                          </Col>
                                          <Col xs={24} md={12}>
                                              <ul className="info-list">
                                                  ...
                                                  <li>
                                                      <div className="icon-wrapper"><ExpandOutlined /></div>
                                                      <div className="info-text">
                                                  ...
                                                  <li>
                                                      ...
                                                      <div className="info-text">
                                                          ...
                                                          <span className="value">{artifact.rating || 0}/5 <span className="sub">({artifact.total_reviews || 0} reviews)</span></span>
                                                      </div>
                                                  </li>
                                                  <li>
                                                      ...
                                                      <div className="info-text">
                                                          ...
                                                          <span className="value highlight-unesco">Bảo vật Quốc gia</span>
                                                      </div>
                                                  </li>
                                              </ul>
                                          </Col>
                          ...
                          children: (
                              <div className="article-main-wrapper">
                                  ...
                                  <div className="discovery-block" style={{marginBottom: 48}}>
                                      ...
                                      <p>Tham gia các màn chơi tương tác để hiểu rõ hơn về hiện vật này.</p>
                                      <Row gutter={[16, 16]}>
                                          <Col xs={24} md={12}>
                                              <div className="game-card-mini" style={{border: '1px solid #eee', borderRadius: 12, padding: 16, display: 'flex', gap: 16, alignItems: 'center'}}>
                                                  ...
                                                  <div className="game-info" style={{flex: 1}}>
                                                      <h4 style={{margin: 0, fontSize: 16}}>Khám phá Rồng đá</h4>
                                                      <div style={{color: '#888', fontSize: 13}}>Giải mã bí ẩn về rồng đá thời Lê</div>
                                                  </div>
                                          ...
                                          <Col xs={24} md={12}>
                                              <div className="game-card-mini" style={{border: '1px solid #eee', borderRadius: 12, padding: 16, display: 'flex', gap: 16, alignItems: 'center'}}>
                                                  ...
                                                  <div className="game-info" style={{flex: 1}}>
                                                      <h4 style={{margin: 0, fontSize: 16}}>Bảo vệ Hoàng Thành</h4>
                                                      <div style={{color: '#888', fontSize: 13}}>Bảo vệ di sản khỏi xâm lược</div>
                                                  </div>
                                                  <Button type="primary" shape="round" icon={<RocketOutlined />}>Chơi Ngay</Button>
                                              </div>
                                          </Col>
                                  ...
                                  {(relatedHeritage.length > 0 || relatedHistory.length > 0) && (
                                    <div className="discovery-block" style={{marginBottom: 48}}>
                                        <Title level={3}><EnvironmentOutlined /> Di sản & Lịch sử liên quan</Title>
                                        <Row gutter={[16, 16]}>
                                  ...
                                  <div className="discovery-block">
                                      ...
                                      <p>Các sản phẩm lưu niệm và văn hóa liên quan đến hiện vật này.</p>
                                      <Row gutter={[16, 16]}>
                                          <Col xs={24} sm={12} md={6}>
                                               <div className="product-card" style={{textAlign: 'center', border: '1px solid #f0f0f0', borderRadius: 8, padding: 16}}>
                                                   <div className="prod-img" style={{height: 200, marginBottom: 16, borderRadius: 8, overflow: 'hidden', background: '#f5f5f5'}}>
                                                   ...
                                                   <h4 style={{marginBottom: 8, fontSize: 15}}>Mô hình Rồng đá</h4>
                                                   <div style={{color: '#d4380d', fontWeight: 'bold', fontSize: 16, marginBottom: 12}}>350,000 đ</div>
                                                   <Button block type="primary" ghost>Xem chi tiết</Button>
                                               </div>
                                          </Col>
                                          <Col xs={24} sm={12} md={6}>
                                               <div className="product-card" style={{textAlign: 'center', border: '1px solid #f0f0f0', borderRadius: 8, padding: 16}}>
                                                   ...
                                                   <h4 style={{marginBottom: 8, fontSize: 15}}>Móc khóa Rồng đá</h4>
                                                   <div style={{color: '#d4380d', fontWeight: 'bold', fontSize: 16, marginBottom: 12}}>45,000 đ</div>
                                                   <Button block type="primary" ghost>Xem chi tiết</Button>
                                               </div>
                                          </Col>
                                          <Col xs={24} sm={12} md={6}>
                                               <div className="product-card" style={{textAlign: 'center', border: '1px solid #f0f0f0', borderRadius: 8, padding: 16}}>
                                                   <div className="prod-img" style={{height: 200, marginBottom: 16, borderRadius: 8, overflow: 'hidden', background: '#f5f5f5'}}>
                                                       <img src="https://images.unsplash.com/photo-1555169062-013468b47731?w=400" alt="Product" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
                                                   </div>
                                                   <h4 style={{marginBottom: 8, fontSize: 15}}>Tranh Rồng đá</h4>
                                                   <div style={{color: '#d4380d', fontWeight: 'bold', fontSize: 16, marginBottom: 12}}>280,000 đ</div>
                                                   <Button block type="primary" ghost>Xem chi tiết</Button>
                                               </div>
                                          </Col>
                                      </Row>
