...
const AIChat: React.FC = () => {
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            role: 'assistant',
            content: 'Xin chào! Mình là trợ lý Sen. Mình sẽ hướng dẫn bạn khám phá di sản văn hóa Việt Nam! 🌸'
        }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const fullResponse = response.data.data.message || 'Xin lỗi, mình không thể trả lời câu hỏi này.';
            ...
            <div className="messages-container">
                {messages.map((message) => (
                    ...
                    >
                        <Avatar
                            ...
                            style={{
                                backgroundColor: message.role === 'user' ? '#1f5f25' : '#d4b070'
                            }}
                        />
                ...
                {loading && !streamingText && (
                    <div className="message assistant">
                        <Avatar className="message-avatar" icon="🌸" style={{ backgroundColor: '#d4b070' }} />
                        <div className="message-content">
                            <div className="message-bubble">
