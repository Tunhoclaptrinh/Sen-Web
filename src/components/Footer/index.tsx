    ...
    return (
        <footer className="footer">
            <div className="footer-decorations">
                <img src={smoke_right} className="smoke-decor smoke-right" alt="smoke decoration" />
                <img src={lotus_1} className="lotus-decor lotus-left" alt="lotus decoration" />
                <img src={lotus_2} className="lotus-decor lotus-center" alt="lotus decoration" />
                <img src={lotus_3} className="lotus-decor lotus-right" alt="lotus decoration" />
            </div>
            ...
            <div className="footer-content">
                <Row gutter={[48, 32]}>
                    ...
                    <Col xs={24} md={5}>
                        ...
                        <Paragraph className="footer-text">
                            FB: Sen - Kiến tạo trải nghiệm lịch sử, văn hoá bằng công nghệ
                        </Paragraph>
