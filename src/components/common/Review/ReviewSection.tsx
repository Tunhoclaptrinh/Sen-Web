  ...
  return (
    <div className="review-section-container">
      <div className="review-section-header">
        <h2 className="section-title">{t('common.reviews.title')}</h2>
        <div className="review-stats-bar">
          ...
          <div className="total-reviews-summary">
            <Trans i18nKey="common.reviews.stats" values={{ count: totalReviews || 0 }}>
      ...
      <div className="review-main-content">
        <Card className="review-list-card" bordered={false}>
          <div className="list-header">
            <h3>
              <MessageOutlined /> {t('common.reviews.allComments')} ({pagination.total || 0})
            </h3>
            <Button
              type="primary"
            ...
            >
              {showForm ? t('common.reviews.closeBtn') : t('common.reviews.writeBtn')}
            </Button>
          </div>
