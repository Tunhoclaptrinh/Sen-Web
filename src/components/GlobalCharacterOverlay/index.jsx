// src/components/GlobalCharacterOverlay/index.jsx
...
const GlobalCharacterOverlay = () => {
  const { position, updatePosition, isVisible, isTalking, setIsTalking } =
    useGlobalCharacter();
  ...
  return (
    <>
      ...
      <div
        ...
        onDoubleClick={() => setShowModal(true)} // Mở modal khi click
      >
        {!visibleChar ? (
          <Stage
            width={CHAR_WIDTH}
